...
def research_and_cv(data: dict) -> dict:
    ...
    return {'research': f'''      <section class="section research-section" id="research" aria-labelledby="research-title"><div class="container"><div class="section-heading"><div><span class="eyebrow section-index">01 / RESEARCH</span><h2 id="research-title">A common thread.<br><em>Across different signals.</em></h2></div><p>Contrastive objectives and shared representations<br class="desktop-break"> across modalities, tasks, and domains.</p></div><div class="research-grid">{research}</div><div class="keyword-strip">{keywords}</div></div></section>
